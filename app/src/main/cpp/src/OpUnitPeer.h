...
{
public:
    OpUnitPeer(Wrapper* const vWrapper, BluetoothServerSocket* vBluetoothServerSocket, BluetoothSocket* vBluetoothSocket, BluetoothDevice* vBluetoothDevice, const String& vsMac);
    OpUnitPeer(Wrapper* const vWrapper, BluetoothDevice* vBluetoothDevice, const String& vsMac);
