...
{
    NWrapper::w->mNVisitorViewViewGroup->tRun(NWrapper::w->mNEta00, (NParam)this, (NParam)view, (NParam)index);
}
...
{
    NWrapper::w->mNVisitorViewViewGroup->tRun(NWrapper::w->mNEpsilon00, (NParam)this, (NParam)index);
}

void ViewGroup::requestLayout()
{
    NWrapper::w->mNVisitorViewViewGroup->tRun(NWrapper::w->mNDzeta00, (NParam)this);
}
