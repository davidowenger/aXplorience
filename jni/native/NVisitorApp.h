...
public:
   ...
   ~NVisitorApp()
	...
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onCreate();
		return 0;
	}

	NReturn visit(NBeta00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onDestroy();
		return 0;
	}

	NReturn visit(NGamma00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onPause();
		return 0;
	}

	NReturn visit(NDelta00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onRestart();
		return 0;
	}

	NReturn visit(NEpsilon00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onResume();
		return 0;
	}

	NReturn visit(NDzeta00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onStart();
		return 0;
	}

	NReturn visit(NEta00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onStop();
		return 0;
	}

	NReturn visit(NTheta00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onActivityResult(a, b, c, d);
		return 0;
	}

	NReturn visit(NOmicron00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onReceiveDiscoveryFinished();
		return 0;
	}

	NReturn visit(NPi00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onReceiveDiscoveryStarted();
		return 0;
	}
	...
	NReturn visit(NRho00* element, NParam a, NParam b, NParam c, NParam d)
	{
		if (!a) {
			...
			NSDEVICE::Activity::kActivity->w->dActivity->onReceiveFoundDevice((NSDEVICE::BluetoothDevice*)a);
		}
		return (NReturn)a;
	}
	...
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onReceiveLocalName(NSDEVICE::Activity::kActivity->w->nFrame->tGetString(NSDEVICE::Activity::kActivity->w->nFrame->tRunObject((NParam)a)));
		return 0;
	}

	NReturn visit(NTau00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onReceiveScanMode(a, b);
		return 0;
	}

	NReturn visit(NUpsilon00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->onReceiveState(a, b);
		return 0;
	}

	NReturn visit(NPhi00* element, NParam a, NParam b, NParam c, NParam d)
	{
		NSDEVICE::Activity::kActivity->w->dActivity->handleMessage(a, b, c);
		return 0;
	}
};
