...
public:
	...
	virtual NReturn accept(NVisitor* visitor, NParam a = 0, NParam b = 0, NParam c = 0, NParam d = 0) = 0;
...
{
public:
    NReturn accept(NVisitor* visitor, NParam a = 0, NParam b = 0, NParam c = 0, NParam d = 0);
};
