...
class NVisitorAppFragment : public NKrossVisitor
{
public:
    ...
    {
        NReturn vcRet = 0;
        if (b == -1 && c == 1) vcRet = (NReturn)mNWrapper->mNKrossWrapper->mNKrossFriend->pointer<Activity>();
    ...
    {
        NReturn vcRet = 0;
        if (b == -1 && c == 3) vcRet = (NReturn)mNWrapper->mNKrossWrapper->mNKrossFriend->pointer<LayoutInflater>();
        if (b == -1 && c == 2) vcRet = (NReturn)mNWrapper->mNKrossWrapper->mNKrossFriend->pointer<ViewGroup>();
        if (b == -1 && c == 1) vcRet = (NReturn)mNWrapper->mNKrossWrapper->mNKrossFriend->pointer<Bundle>();
    ...
    {
        NReturn vcRet = 0;
        if (b == -1 && c == 2) vcRet = (NReturn)mNWrapper->mNKrossWrapper->mNKrossFriend->pointer<Menu>();
        if (b == -1 && c == 1) vcRet = (NReturn)mNWrapper->mNKrossWrapper->mNKrossFriend->pointer<MenuInflater>();
